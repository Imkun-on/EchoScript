...
hiddenimports = ['server',
                 ...
                 'server.transcription.groq_api',
                 'server.transcription.local_whisper',
                 'server.enrichment', 'server.enrichment.summary',
                 'server.enrichment.vision',
